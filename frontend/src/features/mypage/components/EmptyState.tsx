...
export default function EmptyState({ title, description, action }: Props) {
  return (
      <div className="flex min-h-[130px] w-full flex-col items-center justify-center gap-2 rounded-[30px] border border-line bg-white px-6 py-10 text-center shadow-card">
